...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='../../data/cipher/default', help='Path to train/val dataset')
    ...
    eval_encodings, eval_labels, eval_mem_patterns = preprocess_data(eval_data, 'val')
    ...
    trainer = CustomTrainer(
        ...
        callbacks=[EvaluateEveryNEpochsCallback(eval_every_n_epochs=1)],
    )
